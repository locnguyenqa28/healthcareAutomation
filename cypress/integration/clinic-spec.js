...
describe("Clinic", () => {
  ...
  it.skip("11. Edit clinic Laboratory", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it.skip("12. Multiple Edit clinic Laboratory", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it.skip("13. Edit Multiple clinics Laboratory", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it.skip("14. Edit clinic all values", () => 
  {
  ...
  it.skip("15. Edit Multiple clinics all values", () => 
  {
