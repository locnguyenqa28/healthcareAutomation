...
describe("Large image testing", () => {
  ...
  it("3.Large images 1 lesions + combine 4 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("4.Large images 2 lesions + combine 4 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("5.Large images 3 lesions + combine 4 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("6.Large images 3 lesions + 4 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it.only("7.Multiple Large images - 5Mb 3 lesions + 3 images", () => 
  {
    ...
    //Add multiple
    dashboardActions.addMuiltiPathologyRequestLargeImagesBySelectRegion('4.99mb.jpg', 3, 5);
  });
});
