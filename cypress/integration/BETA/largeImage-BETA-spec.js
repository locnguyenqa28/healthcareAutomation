...
describe("Large image testing - BETA", () => {
  ...
  it.only("1. Multiple Large images - 10 lesions 4.7Mb x 3 images - 1", () => 
  {
    ...
    //Add multiple
    dashboardActions.addMuiltiPathologyRequestLargeImagesBySelectRegionV2('4.9_2.jpg', 8, 1, 1);
  });
  ...
  it("3. Multiple Large images - 10 lesions 4.7Mb x 3 images - 3", () => 
  {
    ...
    //Add multiple
    dashboardActions.addMuiltiPathologyRequestLargeImagesBySelectRegionV2('4.9_2.jpg', 10, 1, 3);
  });
