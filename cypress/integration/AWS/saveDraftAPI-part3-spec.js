...
describe("Save Draft by API - Part 3", () => {
  ...
  it("Save Draft By API: Full copy - add 7 Lesions - Delete 5 lesions - Combine limited & invalid images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Save Draft By API: Full copy - add 7 Lesions - Delete 4 lesions - Combine limited & invalid images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Save Draft By API: Full copy - add 7 Lesions - Delete 3 lesions - Combine limited & invalid images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Save Draft By API: Full copy - add 7 Lesions - Delete 2 lesions - Combine limited & invalid images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
