...
describe("Print Preview part 1 testing", () => {
  ...
  it("Print Preview: add 5 Lesions - Delete 2 lesions - 5 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Print Preview: add 5 Lesions - Delete 3 lesions - 5 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Print Preview: add 5 Lesions - Delete 4 lesions - 5 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
