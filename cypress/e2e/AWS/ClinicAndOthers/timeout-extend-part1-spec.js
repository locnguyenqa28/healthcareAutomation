...
describe("Timeout extend -par1", () => {
  ...
  it("The timeout-extend popup able to visible at lesion 1 - completed", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("The timeout-extend popup able to visible at lesion 2 completed", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
