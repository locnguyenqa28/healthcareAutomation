...
describe("Application Links", () => {
  ...
  const PPUrl = 'https://www.sonicpathology.com.au/media/6069/shap-privacy-policy-202203.pdf';
  const PPElement = `.footersupport [href="${PPUrl}"]`;
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - Dashboard Page", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
    ...
    dashboardActions.selectClinicOptionByName();
    dashboardActions.clickOkSelectClinic();
    dashboardActions.assertText('Privacy Policy')
    dashboardActions.assertElement(PPElement);
    dashboardActions.clickElement(PPElement);
    cy.url().should('eq', PPUrl);
  });
    
  it("Make sure Privacy Policy link is added in the Ederm footer - Login Page", () => 
  {
    loginActions.visitPage();
    dashboardActions.assertText('Privacy Policy')
    dashboardActions.assertElement(PPElement);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - Patient details Page", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - Clinic Page", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - Lesion Page", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
    ...
    //Add New Lesion - Patient Details
    const firstname = `pplinks-${homeActions.randomAlpha(10)}`;
    const lastname = `${homeActions.randomAlpha(5)}`;
    dashboardActions.selectClinicOptionByName();
    dashboardActions.clickOkSelectClinic();
    dashboardActions.clickAddNewLesion();
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - the Image - no upload", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
    ...
    //Add New Lesion - Patient Details
    const firstname = `applinks-${homeActions.randomAlpha(10)}`;
    const lastname = `${homeActions.randomAlpha(5)}`;
    dashboardActions.selectClinicOptionByName();
    dashboardActions.clickOkSelectClinic();
    dashboardActions.clickAddNewLesion();
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - UploadImage - invalid images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - the Clinical indication - empty", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - the Body Map - empty", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - the Body Map - filled", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - upload image - 3 images", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - lesion 1 - completed", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer - lesion 2 completed", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer -  6 completed", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
  ...
  it("Make sure Privacy Policy link is added in the Ederm footer -  7 completed", () => 
  {
    loginActions.visitPage();
    loginActions.inputUserName(user.username);
    loginActions.inputPassword(user.password);
